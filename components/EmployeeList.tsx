            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 text-slate-600 text-xs uppercase tracking-wider font-semibold">
                  ...
                  <th className="px-6 py-4 text-center">Feriado Legal</th>
                  <th className="px-6 py-4 text-center">Administrativos</th>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <img src={employee.avatarUrl} alt={employee.firstName} className="w-10 h-10 rounded-full object-cover" />
                        <div>
